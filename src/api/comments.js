const comments = [
  ...
  {
    "text": "Initially, the internet wasn’t built to support such dynamic and complex web apps.  A client loads up a page and then nothing happens until the user clicks and navigates to the next page.",
    "date": "10rd November 2017, 3:20 pm",
    "rating": 5
  },
  {
